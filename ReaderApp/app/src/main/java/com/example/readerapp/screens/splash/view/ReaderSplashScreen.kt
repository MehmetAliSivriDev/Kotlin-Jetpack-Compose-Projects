package com.example.readerapp.screens.splash.view
...
//            Log.d("FirebaseUser", "User: ${user?.email}")
    ...
    Surface(
        ...
        Column(
           ...
           ReaderLogo()
            ...
            Text(text = "\" Read. Change Yourself \"", style = MaterialTheme.typography.titleLarge,

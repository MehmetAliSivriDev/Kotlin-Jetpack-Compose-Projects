package com.example.readerapp.screens.login.view
...
import com.example.readerapp.screens.login.viewModel.LoginViewModel

@Composable
fun ReaderLoginScreen(navController: NavController, viewModel: LoginViewModel = viewModel()){
    Surface(
...
fun UserForm(
    ...
    Column(
        ...
        Button (
            ...
            else Text(text = "Login", modifier = Modifier.padding(5.dp))
        }
